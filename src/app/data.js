...
export const projectsData = [
  {
    id: 1,
    name: "Fashion Store",
    description: "A sleek fashion store built with the MERN stack, offering a responsive UI for browsing, filtering, and purchasing items, backed by secure authentication and smooth checkout.",
    date: "2025-Jan-16",
    demoLink: "https://github.com/Abbas-Razaa/Fashion-Store",
  },
  {
    id: 2,
...
export const BtnList = [
  ...
  {
    label: "Resume",
    link: "https://drive.google.com/file/d/1H2jSs62A-IMq_c5yslFRYLE-h6_Fvw1Z/view?usp=sharing",
    icon: "resume",
    newTab: true,
  },
];
